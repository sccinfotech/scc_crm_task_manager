      ...
      >
        ...
        <div className="grid gap-5 md:grid-cols-[1fr,220px]">
          <div className="rounded-2xl border border-slate-200 bg-slate-100 p-4">
            <div className="mx-auto overflow-hidden rounded-xl border border-slate-300 bg-slate-200">
              <AvatarEditor
                ref={editorRef}
                image={imageSrc}
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                ...
                onClick={handleApply}
                disabled={isSaving}
                className="flex-1 rounded-xl bg-cyan-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-cyan-700 disabled:opacity-50"
              >
