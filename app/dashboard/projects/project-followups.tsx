  ...
  if (loading && followUps.length === 0) {
    return (
      <div className={`h-full flex flex-col bg-white rounded-2xl border border-slate-200 shadow-sm ${className}`}>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 scrollbar-hide" aria-busy="true" aria-label="Loading follow-ups">
            ...
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="relative pl-12">
                <div className="absolute left-0 top-0 mt-1.5 h-10 w-10 flex items-center justify-center z-10">
                  <div className="h-3 w-3 rounded-full bg-slate-200 animate-pulse border-2 border-white shadow-[0_0_0_4px_rgba(6,182,212,0.1)]" />
                </div>
                <div className="bg-white rounded-xl border border-slate-100 p-3 shadow-sm">
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="space-y-1.5">
                        <span className="block h-3.5 w-24 rounded bg-slate-200 animate-pulse" />
                  ...
                  <div className="mt-2 pt-2 border-t border-slate-50">
                    <span className="block h-5 w-28 rounded-lg bg-slate-100 animate-pulse" />
                  </div>
                </div>
              </div>
            ))}
