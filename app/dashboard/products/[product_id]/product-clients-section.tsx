...
interface ProductClientsSectionProps {
...
export function ProductClientsSection({
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex-1 overflow-y-auto bg-slate-50 px-4 py-4 rounded-2xl border border-slate-200">
        {loading && (
