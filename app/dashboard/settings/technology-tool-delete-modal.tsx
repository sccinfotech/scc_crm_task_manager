...
interface TechnologyToolDeleteModalProps {
  isOpen: boolean
  onClose: () => void
  onConfirm: () => void
  toolName: string
...
export function TechnologyToolDeleteModal({
  isOpen,
  onClose,
  onConfirm,
  toolName,
  isLoading = false,
}: TechnologyToolDeleteModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl bg-white shadow-xl">
        <div className="border-b border-gray-200 px-6 py-4">
          <h2 className="text-xl font-semibold text-[#1E1B4B]">Delete Tool</h2>
        </div>
          ...
          <div className="mb-4 flex items-start gap-4">
            ...
            <div className="flex-1">
              <p className="text-sm text-gray-600">
                Are you sure you want to delete <span className="font-semibold text-[#1E1B4B]">{toolName}</span>?
