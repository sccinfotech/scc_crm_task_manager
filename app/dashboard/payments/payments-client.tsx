...
export function PaymentsClient({ projects, initialSearch, initialStatus }: PaymentsClientProps) {
  ...
  return (
    <div className="flex h-full flex-col p-2 sm:p-3 lg:p-4">
      ...
      <div className="flex-1 min-h-0 rounded-2xl border border-slate-200 bg-white flex flex-col overflow-hidden">
          ...
          {projects.length === 0 ? (
            <div className="flex h-full items-center justify-center p-6">
              <EmptyState
                ...
                description="Projects that have at least one requirement (from the Project Requirements tab) will appear here for payment tracking."
              />
            </div>
          ) : (
